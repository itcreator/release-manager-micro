...
func NewReleaseManagerAPI(spec *loads.Document) *ReleaseManagerAPI {
	return &ReleaseManagerAPI{
		...
		ProjectReadProjectHandler: project.ReadProjectHandlerFunc(func(params project.ReadProjectParams) middleware.Responder {
			return middleware.NotImplemented("operation ProjectReadProject has not yet been implemented")
		}),
		VersionSemanticSemverGenerateHandler: version_semantic.SemverGenerateHandlerFunc(func(params version_semantic.SemverGenerateParams) middleware.Responder {
			return middleware.NotImplemented("operation VersionSemanticSemverGenerate has not yet been implemented")
		}),
