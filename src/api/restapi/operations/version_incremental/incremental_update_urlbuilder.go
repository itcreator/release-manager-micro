...
func (o *IncrementalUpdateURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("ProjectName is required on IncrementalUpdateURL")
	}
...
func (o *IncrementalUpdateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on IncrementalUpdateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on IncrementalUpdateURL")
	}
