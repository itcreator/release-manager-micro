...
func (o *IncrementalGenerateURL) WithBasePath(bp string) *IncrementalGenerateURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *IncrementalGenerateURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("ProjectName is required on IncrementalGenerateURL")
	}
...
func (o *IncrementalGenerateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on IncrementalGenerateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on IncrementalGenerateURL")
	}
