...
// WithUUID adds the uuid to the update project params
func (o *UpdateProjectParams) WithUUID(uuid strfmt.UUID) *UpdateProjectParams {
	o.SetUUID(uuid)
	return o
}

// SetUUID adds the uuid to the update project params
func (o *UpdateProjectParams) SetUUID(uuid strfmt.UUID) {
	o.UUID = uuid
}
